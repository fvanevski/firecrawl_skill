"""Asset-membership binding for durable indexing checkpoints."""
...
class _IndexCheckpointAssetMembershipMixin:
    ...
    def _prepare_asset_membership_if_needed(
        ...
        return self.asset_promotions.prepare_for_indexing(
            run_id, lifecycle_revision=lifecycle_revision
        )
            ...
            payload.update(
                {
                    ...
                    "asset_membership_schema_version": "completion-critical-membership-v1",
                }
            )
        return payload
